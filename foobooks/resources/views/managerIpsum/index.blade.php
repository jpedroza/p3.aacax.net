...
@section('content')
	...
	<h3>Here is a Sample of Program Manager Ipsum Dolor</h3>
	<p>
	...
	<h3>To generate your own custom stuff, just enter how many paragraphs you want, how many sentences per paragraph, and press "Generate."</h3>
	...
	<input type="submit" value=""" style="height: 46px; width: 135px; background:url(img/generatebutton.png);"></form> 
